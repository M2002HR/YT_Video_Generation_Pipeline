...
```json
{
  ...
  "active_phase": null,
  "next_phase": "P00",
  "next_action": "Read applicable AGENTS.md, inspect dev and submodules, preserve worktree, record baseline and begin P00.",
  "execution_chat_plan": {
    "mode": "FOUR_CHAT",
    "selected_during_phase": "P00",
    "selection_status": "RECOMMENDED_DEFAULT_NOT_YET_CONFIRMED",
