...
def launch_schema(projects: list[dict[str, str]], styles: list[str]) -> dict[str, Any]:
    ...
    groups = [
        ...
        {"id": "visual", "title": "Visual direction", "description": "Question Harvest style, image model and opening clips.", "projects": ["question_harvest"], "fields": [
            ...
            _field("reserve_subtitle_space", "Reserve lower space inside images", "toggle", default=True, help="On keeps the current calm 8–10% lower field for subtitles. Off fills the complete illustration window while preserving the frame, texture and continuity."),
