...
STAGES: tuple[StageSpec, ...] = (
    ...
    StageSpec("narration_pacing", "Measured narration pacing", "timing", ("narration_alignment",), ("narration_pacing",)),
    StageSpec("rhythm_map", "Rhythm map", "timing", ("narration_pacing", "voice_performance"), ("rhythm_map",)),
    StageSpec("opening_plan", "Gateway and opening source plan", "planning", ("rhythm_map", "character_resolution"), ("opening_source_plan", "opening_plan")),
    ...
    StageSpec("opening_media", "Gateway opening media", "visual", ("opening_plan", "assets"), ("opening_media_receipt",), provider="flow"),
    StageSpec("media_review", "Optional media review", "visual", ("assets", "opening_media"), ("media_review",), condition_name="media_review", provider="chatgpt"),
    StageSpec("asset_observation", "One-pass edit observation", "visual", ("assets", "opening_media"), ("asset_observations",), condition_name="observation", provider="chatgpt"),
    StageSpec("assets_ready", "Assets ready", "visual", ("assets", "opening_media", "media_review", "asset_observation")),
    StageSpec("edit_direction", "Independent edit direction", "edit", ("assets_ready", "rhythm_map"), ("layout_constraints", "edit_plan"), provider="chatgpt"),
    StageSpec("captions_sound", "Captions, branding and sound", "edit", ("edit_direction", "narration_alignment"), ("caption_plan", "overlay_plan", "music_selection", "sound_plan", "sfx_selection")),
