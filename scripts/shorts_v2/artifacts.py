...
LOGICAL_ARTIFACTS: dict[str, str] = {
    ...
    "caption_plan": "editing/CAPTION_PLAN.json",
    "overlay_plan": "editing/OVERLAY_PLAN.json",
    "music_selection": "editing/MUSIC_SELECTION.json",
    "sound_plan": "editing/SOUND_PLAN.json",
    "sfx_selection": "editing/SFX_SELECTION.json",
    "presentation_compile": "editing/PRESENTATION_COMPILE.json",
