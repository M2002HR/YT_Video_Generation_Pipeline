...
def normalize_release_settings(value: Any) -> dict[str, Any]:
    ...
    for name in ("shadow", "text_background", "badge_enabled", "preview_small", "comparison_sheet", "send_previews", "send_master_video", "send_comparison_sheet", "send_report_json", "send_raw_artwork", "resend", "review_enabled"):
